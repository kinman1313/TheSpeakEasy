...
/**
 * Handles pinning a message in a room.
 * @param {Object} io - The Socket.IO server instance.
 * @param {Object} socket - The Socket.IO socket instance.
 * @param {Object} data - The pin message data.
 */
...
/**
 * Handles creating a direct message (DM) room between two users.
 * @param {Object} io - The Socket.IO server instance.
 * @param {Object} socket - The Socket.IO socket instance.
 * @param {Object} data - The DM creation data.
 */
...
/**
 * Handles fetching message history for a room.
 * @param {Object} socket - The Socket.IO socket instance.
 * @param {Object} data - The history request data.
 */
const handleGetHistory = async (socket, data) => {
    try {
        const { roomId, limit = DEFAULT_MESSAGE_LIMIT, before } = data;
        const query = { roomId };
...
/**
 * Handles typing status updates for a room.
 * @param {Object} io - The Socket.IO server instance.
 * @param {Object} socket - The Socket.IO socket instance.
 ...
 * @param {Object} io - The Socket.IO server instance.
 * @param {Object} socket - The Socket.IO socket instance.
 * @param {Object} data - The reaction data.
 */
 ...
 * @param {Object} io - The Socket.IO server instance.
 * @param {Object} socket - The Socket.IO socket instance.
 * @param {Object} data - The remove reaction data.
 */
